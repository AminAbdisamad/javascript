...
function removeTask(e){
    (e.target.parentElement.classList.contains('delete')) ? e.target.parentElement.parentElement.remove() : '' ;
    e.preventDefault();
}
function addTask(e){
    ...
    deleteBtnLink.className = "btn-floating btn-smaller red delete secondary-content";
    deleteBtnLink.innerHTML = '<i class="material-icons">delete</i></a>';
    //Create delete btn
    const editBtnLink = document.createElement('a');
    editBtnLink.className = "btn-floating btn-smaller green edit secondary-content";
    editBtnLink.innerHTML = '<i class="material-icons">mode_edit</i></a>';
    //Create delete btn
    const doneBtnLink = document.createElement('a');
    doneBtnLink.className = "btn-floating btn-smaller edit orange darken-2 secondary-content";
